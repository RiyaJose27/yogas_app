...
<form:form action="/makeYoga" method="post" modelAttribute="yoga">
...
<p>
  ...
  <p>
   ...
   <form:label path="published_on">published_on</form:label>
   <form:errors path="published_on"/>
   <form:input path="published_on"/>
   </p>
